          ...
          <div className="mt-3 flex justify-between items-center">
            <div>
              ...
              <input
                ...
                aria-label="SKU"
                className="w-7/10 px-3 py-2 border border-gray-300 text-xs text-gray-400 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
              />
            </div>
            <div>
              ...
              <input
                ...
                aria-label="Tax Rate (%)"
                className="w-full px-3 py-2 border border-gray-300 text-xs text-gray-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
              />
            </div>
