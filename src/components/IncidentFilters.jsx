...
const InvoiceFilters = ({ filters, onFilterChange, onClearFilters }) => {
        ...
        <div className="absolute right-0 mt-2 w-80 bg-white border rounded-lg shadow-lg z-10 p-4">
          <div className="space-y-3">
            <div>
              ...
              <input
                type="text"
                placeholder="Search invoice number, customer name, or reference..."
            ...
            <div className="grid grid-cols-2 gap-2">
              <div>
                <label className="block text-sm font-medium text-brand-700 mb-1">From Date</label>
                <input
                  type="date"
              ...
              <div>
                <label className="block text-sm font-medium text-brand-700 mb-1">To Date</label>
                <input
                  type="date"
